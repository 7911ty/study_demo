...
class StandardActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.mode_bt_1 -> {
                startActivity(Intent(StandardActivity@ this, SingleInstanceActivity::class.java))
            }
            R.id.mode_bt_2 -> {
                startActivity(Intent(StandardActivity@ this, SingleTopActivity::class.java))
            }
            R.id.mode_bt_3 -> {
                startActivity(Intent(StandardActivity@ this, SingleTaskActivity::class.java))
            }
            R.id.mode_bt_4 -> {
                startActivity(Intent(StandardActivity@ this, StandardActivity::class.java))
            }
        }
    }
}