...
class SingleTaskActivity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.mode_bt_1 -> {
                startActivity(Intent(SingleTaskActivity@ this, SingleInstanceActivity::class.java))
            }
            R.id.mode_bt_2 -> {
                startActivity(Intent(SingleTaskActivity@ this, SingleTopActivity::class.java))
            }
            R.id.mode_bt_3 -> {
                startActivity(Intent(SingleTaskActivity@ this, SingleTaskActivity::class.java))
            }
            R.id.mode_bt_4 -> {
                startActivity(Intent(SingleTaskActivity@ this, StandardActivity::class.java))
            }
        }
    }
}